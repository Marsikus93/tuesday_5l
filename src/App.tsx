...
function App() {
    ...
    function removeTask(taskId: string, todolistId: number) {
        setTodo(todo.map((el, index) => index === todolistId ? {...el, tasks: el.tasks.filter(f => f.taskId !== taskId)}
            : el))
    ...
    function addTask(title: string, todolistId: number) {
        ...
        setTodo(todo.map((el, index) => index === todolistId ? {...el, tasks: [newTask, ...el.tasks]}
            : el))
        // //достанем нужный массив по todolistId:
        // let todolistTasks = tasks[todolistId];
    ...
    function changeStatus(id: string, isDone: boolean, todolistId: number) {
        setTodo(todo.map((el, index) => index === todolistId ? {...el, tasks:el.tasks.map(t=>t.taskId===id?{...t,isDone}
                    :t)}
            : el))
        // //достанем нужный массив по todolistId:
        // let todolistTasks = tasks[todolistId];
    ...
    function changeFilter(value: FilterValuesType, todolistId: number) {
        setTodo(todo.map((el,index)=>index===todolistId?{...el,filter:value}
            :el))
